...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT * FROM clientes INNER JOIN lineas ON clientes.id = lineas.cliente_id WHERE lineas.fecha BETWEEN '$hoy' AND DATE_ADD('$hoy', INTERVAL 3 MONTH) AND clientes.user_id = $user_id";
